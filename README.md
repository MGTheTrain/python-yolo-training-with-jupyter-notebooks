...
Modify [train.txt](data-custom/train.txt) to encompass all JPG files for training purposes, and adjust [test.txt](data-custom/test.txt) to incorporate all JPG files for validation.
